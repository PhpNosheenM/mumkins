 ...
 * @property \App\Model\Table\ItemRowsTable&\Cake\ORM\Association\HasMany $ItemRows
 * @property \App\Model\Table\ProductSectionsTable&\Cake\ORM\Association\HasMany $ProductSections
 *
...
class ItemsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('style_no')
            ->maxLength('style_no', 25)
            ->requirePresence('style_no', 'create')
            ->notEmptyString('style_no');
        ...
        $validator
            ->scalar('material_type')
            ->maxLength('material_type', 255)
            ->requirePresence('material_type', 'create')
            ->notEmptyString('material_type');
