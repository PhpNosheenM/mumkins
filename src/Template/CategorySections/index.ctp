                                            ...
                                            <table class="mb-0 table table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="actions">
                                                        ...
                                                        <?= $this->Html->link(__('<i class="pe-7s-note"></i>'), ['action' => 'edit', $category_view->id],['class'=>' btn-condensed btn-xs','escape'=>false]) ?>

                                                        <?= $this->Form->postLink(__('<i class="pe-7s-trash"></i>'), ['action' => 'delete', $category_view->id], ['confirm' => __('Are you sure you want to Deactive # {0}?'),'class'=>'btn btn-xs green','escape'=>false]) ?>
                                                </tr>
                                            <?php } ?>
                                          </tbody>
                                            </table>
