                   ...
                   <div class="col-md-12 card">
                                    ...
                                    <div class="card-body">
                                      <table class="mb-0 table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php $i=1;foreach ($customer as $customer_view) {?>
                                            <tr>
                                                <th scope="row"><?= $i;$i++;?></th>
                                                <td><span id=""><?= $customer_view->name?></span></td>
                                                <td><?= $customer_view->mobile_number?></td>
                                                <td><?= $customer_view->address?></td>
                                                <td><?= $customer_view->state->name?></td>
                                                <td><?= $customer_view->city->name?></td>
                                                <td><?= $customer_view->pincode?></td>
                                                <!-- <td>
