...
<div class="wishlists view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $wishlist->has('item_row') ? $this->Html->link($wishlist->item_row->id, ['controller' => 'ItemRows', 'action' => 'view', $wishlist->item_row->id]) : '' ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Customer') ?></th>
            <td><?= $wishlist->has('customer') ? $this->Html->link($wishlist->customer->id, ['controller' => 'Customers', 'action' => 'view', $wishlist->customer->id]) : '' ?></td>
        </tr>
        <tr>
