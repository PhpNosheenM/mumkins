/* * ©2016 Quicken Loans Inc. All rights reserved. */ /* global jQuery FormData FileReader */ (function ($) {
    $.fn.uploader = function (options, testMode) {
        return this.each(function (index) {
            options = $.extend({
                submitButtonCopy: 'Upload Selected Files',
                instructionsCopy: 'Select only 4 Images',
                furtherInstructionsCopy: 'Select only 4 Images.',
                selectButtonCopy: 'Select Image',
                secondarySelectButtonCopy: 'Select Image',
                dropZone: $(this),
            ...
            function addItem (file) {
                ...
                // if(id > 3){
                //     alert("Please don't add More than 4 images");
                ...
                if(id > 3){
                    alert("More than 4 images selected");
                $('.hider').prop('disabled', true);
                }
                  

                 $('.js-upload-remove-button').on('click', function(){
                   if (id > 3) {
                    state.listIndex--;
